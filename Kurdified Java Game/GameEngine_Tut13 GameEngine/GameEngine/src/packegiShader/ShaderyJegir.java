...
public class ShaderyJegir extends programyShader{
	...
	private int Shwenyshwenyrwnaky;
	private int Shwenyrangyrwnaky;
	private int shwenykzbwnyRangdanawa;
	private int shwenyRangdanawa;
	public ShaderyJegir() {
...
super.baindySifatakan(2, "normal");
	}
	...
	protected void wargrtnyHamwShwenyUniformakan() {
		...
		Shwenyshwenyrwnaky=super.ShwenyUniformWargra("shwenyrwnaky");
		Shwenyrangyrwnaky=super.ShwenyUniformWargra("rangyrwnaky");
		shwenykzbwnyRangdanawa= super.ShwenyUniformWargra("kzbwnyRangdanawa");
		shwenyRangdanawa = super.ShwenyUniformWargra("rangdanawa");
	}
	

	public void lodyGorawakanyRangdanawa(float kz,float Rangdanawa) {
		
		super.FloatLodKa(shwenykzbwnyRangdanawa, kz);
		super.FloatLodKa(shwenyRangdanawa, Rangdanawa);
	}
	...
	public void RwnakyLodka(Rwnaky rwnaky){
		super.TirLodka(Shwenyshwenyrwnaky, rwnaky.getShwen());
		super.TirLodka(Shwenyrangyrwnaky, rwnaky.getRang());
	}
